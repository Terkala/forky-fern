...
admin-smite-remove-all-limbs-self = Your arms and legs fall off!
admin-smite-remove-all-limbs-other = {CAPITALIZE($name)}'s arms and legs fall off!
admin-smite-restore-all-limbs-self = Your limbs are restored!
admin-smite-restore-all-limbs-other = {CAPITALIZE($name)}'s limbs are restored!
admin-smite-cybernetics-replacement-self = Your limbs are replaced with cybernetics!
admin-smite-cybernetics-replacement-other = {CAPITALIZE($name)}'s limbs are replaced with cybernetics!
...
admin-smite-remove-all-limbs-name = Remove all limbs
admin-smite-restore-all-limbs-name = Restore all limbs
admin-smite-cybernetics-replacement-name = Replace with cybernetics
...
admin-smite-remove-all-limbs-description = Removes their arms and legs, dropping them like surgery.
admin-smite-restore-all-limbs-description = Restores arms, legs, and head from their species prototype.
admin-smite-cybernetics-replacement-description = Replaces arms and legs with pre-filled cyber limbs (capacitor, manipulator, battery, matter bin).
